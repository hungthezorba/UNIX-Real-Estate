...
--
INSERT INTO
  `feedback` (`fid`, `uid`, `fdescription`, `status`, `date`)
VALUES
  (
    2,
    15,
    'DuyHungMinh simplified my life. It aided me in my quest for my first investment, a one-bedroom flat in Nguyen Hue street. Thank you for offering useful tools like the EMI calculator and quick search.\r\n',
    1,
    '2022-04-05'
  ),
  (
    3,
    18,
    'I am a young professional, and DuyHungMinh search assisted me in narrowing down my house options in Ho Chi Minh City. I discovered what kind of property will cost me how much and what kinds of features I will receive.',
    1,
    '2022-04-06'
  ),
  (
    4,
    21,
    'I was looking for a flat in Hanoi, and the DuyHungMinh website made it easy for me to find one. Not only could I pick the property, but I could also read what others had to say about the location. The website is straightforward and easy to navigate.\r\n',
    1,
    '2022-03-25'
  ),
  (
    5,
    23,
    'The ongoing contact via other legitimate calls astounded me. They dispatched an officer to obtain pictures of my store and swiftly uploaded all of the images, assisting me in quickly obtaining a renter. DuyHungMinh deserves a pat on the back.\r\n',
    1,
    '2022-04-08'
  ),
  (
    6,
    24,
    'Early this year, I relocated to Da Nang City from Japan, and I searched online for a good flat for rent in the Andheri region. Thank you, DuyHungMinh, for providing me with so many time search alternatives.\r\n',
    0,
    '2022-02-10'
  );
...
VALUES
  (
    ...
    1256,
    1842432,
    'D2 Street Ward 25 Binh Thanh Ho Chi Minh City',
    'Ho Chi Minh City',
    'District 4',
  ...
  (
    13,
    'suraj',
    'Area: 4x15m 1T 3L 6P 6WC full air-conditioned rooms. The house has two fronts, front and back, the first part of D1 is behind the Pearl Plaza building. Bustling Business District is a prime location with a bustling population. The house has just been repainted, the house is close to schools at all levels to major universities in zone D: Hutech, Transport, Foreign Trade. The house is suitable for customers to open VPCT, VP representative, VP Courier, hair salon, beauty salon, spa makeup nail, clothing shop, English class center, yoga class, studio, open dental clinic, shop pets, showroom, chain of milk tea, coffee, spicy noodles,...',
    'sacsac',
    '2 ASC',
    'sale',
    3,
    ...
    152,
    2903142,
    'D1 Street Ward 25 Binh Thanh Ho Chi Minh City ',
    'Ho Chi Minh City',
    'District 4',
    '<div class=\"col-md-4\">\r\n													<ul>\r\n													<li class=\"mb-3\"><span class=\"text-secondary font-weight-bold\">Property Age : </span>10 Years</li>\r\n													<li class=\"mb-3\"><span class=\"text-secondary font-weight-bold\">Swiming Pool : </span>Yes</li>\r\n													\r\n													<li class=\"mb-3\"><span class=\"text-secondary font-weight-bold\">Parking : </span>Yes</li>\r\n													</ul>\r\n													</div>\r\n													<div class=\"col-md-4\">\r\n													<ul>\r\n													<li class=\"mb-3\"><span class=\"text-secondary font-weight-bold\">Type : </span>Appartment</li>\r\n													<li class=\"mb-3\"><span class=\"text-secondary font-weight-bold\">Security : </span>Yes</li>\r\n													<li class=\"mb-3\"><span class=\"text-secondary font-weight-bold\">Dining Capacity : </span>10 People</li>\r\n													\r\n													</ul>\r\n													</div>\r\n													<div class=\"col-md-4\">\r\n													<ul>\r\n													<li class=\"mb-3\"><span class=\"text-secondary font-weight-bold\">3rd Party : </span>No</li>\r\n													<li class=\"mb-3\"><span class=\"text-secondary font-weight-bold\">Alivator : </span>Yes</li>\r\n													<li class=\"mb-3\"><span class=\"text-secondary font-weight-bold\">Water Supply : </span>Ground Water / Tank</li>\r\n													</ul>\r\n													</div>',
    '111.jpg',
  ...
  (
    ...
    2132,
    1234567,
    'Dien Bien Phu Street Ward 25 Binh Thanh Ho Chi Minh City',
    'Ho Chi Minh City',
    'District 7',
    '<div class=\"col-md-4\">\r\n													<ul>\r\n													<li class=\"mb-3\"><span class=\"text-secondary font-weight-bold\">Property Age : </span>10 Years</li>\r\n													<li class=\"mb-3\"><span class=\"text-secondary font-weight-bold\">Swiming Pool : </span>Yes</li>\r\n													\r\n													<li class=\"mb-3\"><span class=\"text-secondary font-weight-bold\">Parking : </span>Yes</li>\r\n													</ul>\r\n													</div>\r\n													<div class=\"col-md-4\">\r\n													<ul>\r\n													<li class=\"mb-3\"><span class=\"text-secondary font-weight-bold\">Type : </span>Appartment</li>\r\n													<li class=\"mb-3\"><span class=\"text-secondary font-weight-bold\">Security : </span>Yes</li>\r\n													<li class=\"mb-3\"><span class=\"text-secondary font-weight-bold\">Dining Capacity : </span>10 People</li>\r\n													\r\n													</ul>\r\n													</div>\r\n													<div class=\"col-md-4\">\r\n													<ul>\r\n													<li class=\"mb-3\"><span class=\"text-secondary font-weight-bold\">3rd Party : </span>No</li>\r\n													<li class=\"mb-3\"><span class=\"text-secondary font-weight-bold\">Alivator : </span>Yes</li>\r\n													<li class=\"mb-3\"><span class=\"text-secondary font-weight-bold\">Water Supply : </span>Ground Water / Tank</li>\r\n													</ul>\r\n													</div>',
    '1.jpg',
  ...
  (
    ...
    1683,
    1029384,
    '237 Highway 13 Ward 26 Binh Thanh District',
    'Ho Chi Minh City',
    'District 7',
    '<div class=\"col-md-4\">\r\n													<ul>\r\n													<li class=\"mb-3\"><span class=\"text-secondary font-weight-bold\">Property Age : </span>10 Years</li>\r\n													<li class=\"mb-3\"><span class=\"text-secondary font-weight-bold\">Swiming Pool : </span>Yes</li>\r\n													\r\n													<li class=\"mb-3\"><span class=\"text-secondary font-weight-bold\">Parking : </span>Yes</li>\r\n													</ul>\r\n													</div>\r\n													<div class=\"col-md-4\">\r\n													<ul>\r\n													<li class=\"mb-3\"><span class=\"text-secondary font-weight-bold\">Type : </span>Appartment</li>\r\n													<li class=\"mb-3\"><span class=\"text-secondary font-weight-bold\">Security : </span>Yes</li>\r\n													<li class=\"mb-3\"><span class=\"text-secondary font-weight-bold\">Dining Capacity : </span>10 People</li>\r\n													\r\n													</ul>\r\n													</div>\r\n													<div class=\"col-md-4\">\r\n													<ul>\r\n													<li class=\"mb-3\"><span class=\"text-secondary font-weight-bold\">3rd Party : </span>No</li>\r\n													<li class=\"mb-3\"><span class=\"text-secondary font-weight-bold\">Alivator : </span>Yes</li>\r\n													<li class=\"mb-3\"><span class=\"text-secondary font-weight-bold\">Water Supply : </span>Ground Water / Tank</li>\r\n													</ul>\r\n													</div>',
    '01.jpg',
  ...
  (
    ...
    4123,
    1029346,
    'Phu Thuan Ward District 7 Ho Chi Minh',
    'Ho Chi Minh City',
    'District 1',
  ...
  (
    ...
    1342,
    1578345,
    'Nguyen Thi Thap street Him Lam KDC District 7',
    'Ho Chi Minh City',
    'District 8',
  ...
  (
    22,
    'Shanti Apartment',
    '<p>Front house on D4 street, Him Lam area, district 7. Location: Near Him Lam Bridge, near Lotte Mart. Area: 5x20m. Structure: Ground floor basement 3 floors attic with luxurious office architecture, comfortable, polite, with elevator. Surrounding facilities: Near the hospital, near international standard schools, large and small banks around, cafes, pubs, supermarkets, peoples markets, and various utility services around. Easy to move: Go through Q1 15p, go through Q3 10p, move to Q4 Q8 less than 5p. Convenient location, suitable for business, office, teaching center. Price: 65 million/month. Front house on D4 street, Him Lam area, district 7. Location: Near Him Lam Bridge, near Lotte Mart. Area: 5x20m. Structure: Ground floor basement 3 floors attic with luxurious office architecture, comfortable, polite, with elevator. Surrounding facilities: Near the hospital, near international standard schools, large and small banks around, cafes, pubs, supermarkets, peoples markets, and various utility services around. Easy to move: Go through Q1 15p, go through Q3 10p, move to Q4 Q8 less than 5p. Convenient location, suitable for business, office, teaching center. Price: 65 million/month. Front house on D4 street, Him Lam area, district 7. Location: Near Him Lam Bridge, near Lotte Mart. Area: 5x20m. Structure: Ground floor basement 3 floors attic with luxurious office architecture, comfortable, polite, with elevator. Surrounding facilities: Near the hospital, near international standard schools, large and small banks around, cafes, pubs, supermarkets, peoples markets, and various utility services around. Easy to move: Go through Q1 15p, go through Q3 10p, move to Q4 Q8 less than 5p. Convenient location, suitable for business, office, teaching center. Price: 65 million/month. </p>',
    'zcasw',
    '3 ASC',
    'sale',
    3,
    ...
    4125,
    1748432,
    'D4 Street Tan Hung Ward District 7 Ho Chi Minh City',
    'Ho Chi Minh City',
    'District 8',
    '<p>&nbsp;</p>\r\n<!---feature area start--->\r\n<div class=\"col-md-4\">\r\n<ul>\r\n<li class=\"mb-3\"><span class=\"text-secondary font-weight-bold\">Property Age : </span>10 Years</li>\r\n<li class=\"mb-3\"><span class=\"text-secondary font-weight-bold\">Swiming Pool : </span>Yes</li>\r\n<li class=\"mb-3\"><span class=\"text-secondary font-weight-bold\">Parking : </span>Yes</li>\r\n<li class=\"mb-3\"><span class=\"text-secondary font-weight-bold\">GYM : </span>Yes</li>\r\n</ul>\r\n</div>\r\n<div class=\"col-md-4\">\r\n<ul>\r\n<li class=\"mb-3\"><span class=\"text-secondary font-weight-bold\">Type : </span>Appartment</li>\r\n<li class=\"mb-3\"><span class=\"text-secondary font-weight-bold\">Security : </span>Yes</li>\r\n<li class=\"mb-3\"><span class=\"text-secondary font-weight-bold\">Dining Capacity : </span>10 People</li>\r\n<li class=\"mb-3\"><span class=\"text-secondary font-weight-bold\">Temple : </span>Yes</li>\r\n</ul>\r\n</div>\r\n<div class=\"col-md-4\">\r\n<ul>\r\n<li class=\"mb-3\"><span class=\"text-secondary font-weight-bold\">3rd Party : </span>No</li>\r\n<li class=\"mb-3\"><span class=\"text-secondary font-weight-bold\">Alivator : </span>Yes</li>\r\n<li class=\"mb-3\"><span class=\"text-secondary font-weight-bold\">CCTV : </span>Yes</li>\r\n<li class=\"mb-3\"><span class=\"text-secondary font-weight-bold\">Water Supply : </span>Ground Water / Tank</li>\r\n</ul>\r\n</div>\r\n<!---feature area end---->\r\n<p>&nbsp;</p>',
    '1.jpg',
